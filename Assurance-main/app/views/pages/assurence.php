                ...
                <tr>
                    ...
                    <td class="flex gap-[10px]">
                        <a href='<?= URL_ROOT ?>/pages/deleteAssurence?id=<?= $assurence->id_assureur ?>'>
                            <img src="<?php echo URL_ROOT ?>/photos/supprimer.png" class="h-4 me-3 sm:h-10" alt="chaabat" />
                        </a>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="<?= URL_ROOT ?>/pages/addAssereur" method="POST" class="p-4 md:p-5">
                ...
                <button type="submit" name="submit"
                    class="text-white inline-flex items-center bg-green-400 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
